...
if __name__ == "__main__":
    ...
    # Best configuration from W&B
    bz = 512
    lr = 0.0034787
    weight_decay = 1.65e-05
    activation = nn.SiLU()  # "silu"

    # Load CIFAR-10 test data
    _, test_loader = GetCifar10(bz)

    # Model creation
    cfg_vgg6 = [64, 64, 'M', 128, 128, 'M']
    model = vgg(cfg_vgg6, num_classes=10, activation_name=activation, batch_norm=True)
    ...
    print("Best accuracy model loaded")
    ...
    acc, loss = test_model(model, test_loader)
